    ...
    def test_save(self, app):
        with app.app_context():
            ...
            participant_1 = ParticipantEntity(
                id=participant_1_db.id, name="Pierre", email="pierre@fr.fr"
            )
            participant_2 = ParticipantEntity(
                id=participant_2_db.id, name="Paul", email="paul@fr.fr"
            )
            participant_3 = ParticipantEntity(
                id=participant_3_db.id, name="Jacques", email="jacques@fr.fr"
            )
